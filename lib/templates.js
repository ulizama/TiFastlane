...
export const cfgFile =
  ...
  ' , "ios_build_args": "[IOS_BUILD_ARGS]" \n' +
  ' , "android_build_args": "[ANDROID_BUILD_ARGS]" \n' +
  ' , "android_app_id": "[ANDROID_APPLICATION_ID]" \n' +
  "}";
...
export const deliverFile =
  ...
  "\n" +
  "# Please, read this information https://github.com/fastlane/fastlane/blob/master/deliver/Reference.md\n" +
  "\n" +
...
*/
/*
export const Snapfile = "# Uncomment the lines below you want to change by removing the # in the beginning\n" +
"\n" +
...
export const snapshotiPad = "#import \"SnapshotHelper.js\"\n" +
"\n" +
...
export const snapshot = "#import \"SnapshotHelper.js\"\n" +
"\n" +
"var target = UIATarget.localTarget();\n" +
"var app = target.frontMostApp();\n" +
"var window = app.mainWindow();\n" +
...
export const SnapshotHelper = "function wait_for_loading_indicator_to_be_finished()\n" +
"{\n" +
"  try {\n" +
...
// Pilot
export const pilotImport = "John,Appleseed,appleseed_john@mac.com";
