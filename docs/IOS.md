...
If you want to **Upload a beta version** of your app.
...
Generate or renew your push certificates by using:
...
**./screenshots/[LANG]/_._**

As with metadata, screenshots support multi-language. Based on the dimension of the images they will be correctly set to the appropriate device. The images are ordered alphabetically, so make sure to name them correctly to control the right display order.
